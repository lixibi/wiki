...
- **其他**
    ...
    - [编程游戏01](?file=001-CODE/004-其他/03-编程游戏01 "编程游戏01")
- **算法**
    - [用于计算星期的蔡勒公式](?file=001-CODE/005-算法/00-用于计算星期的蔡勒公式 "用于计算星期的蔡勒公式")
...
- **3DS**
- **其他电脑单机**
    - [ever17](?file=005-游戏/05-其他电脑单机/01-ever17 "ever17")
...
- **macos**
    ...
    - [双系统引导clover](?file=006-软件应用/02-macos/05-双系统引导clover "双系统引导clover")
- **跨平台语言**
    - [get-pip.py](?file=006-软件应用/08-跨平台语言/00-get-pip.py "get-pip.py")
...
##### 树莓派
- [树莓派&linux命令](?file=013-树莓派/00-树莓派&linux命令 "树莓派&linux命令")
- [定时任务设置](?file=013-树莓派/01-定时任务设置 "定时任务设置")
- [GPIO](?file=013-树莓派/02-GPIO "GPIO")

##### tb
- [1](?file=015-tb/00-1 "1")

##### 重大决策按钮
- [改键](?file=016-重大决策按钮/00-改键 "改键")
- [开关机版安装方法](?file=016-重大决策按钮/01-开关机版安装方法 "开关机版安装方法")
- [带灯版亮灯](?file=016-重大决策按钮/02-带灯版亮灯 "带灯版亮灯")
- [按钮脚本&#40;初级-组合键,一键启动等&#41;](?file=016-重大决策按钮/03-按钮脚本&#40;初级-组合键,一键启动等&#41; "按钮脚本&#40;初级-组合键,一键启动等&#41;")
- [按钮脚本&#40;进阶-复杂脚本等&#41;](?file=016-重大决策按钮/04-按钮脚本&#40;进阶-复杂脚本等&#41; "按钮脚本&#40;进阶-复杂脚本等&#41;")
- [按钮脚本&#40;高级-物联网,其他语言接口等&#41;](?file=016-重大决策按钮/05-按钮脚本&#40;高级-物联网,其他语言接口等&#41; "按钮脚本&#40;高级-物联网,其他语言接口等&#41;")
